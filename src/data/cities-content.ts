...
export const CITIES_CONTENT: Record<string, {
  ...
  'marion-oaks-fl': {
    ...
    metaDescription: 'Marion Oaks\' #1 fence installation team. Vinyl and aluminum fences. ZIP 34473 & 34476. $0 down financing. Same-day quotes. Call (863) 377-0928.',
    heroTitle: 'Fence Installation in <span class="text-primary">Marion Oaks, FL</span>',
    heroSubtitle: 'Your local Marion Oaks fence team. We live and work right here — vinyl and aluminum fences installed in less than 7 days. $0 down financing.',
    zips: ['34473', '34476'],
  ...
  'ocala-fl': {
    ...
    metaDescription: 'Premium fence installation in Ocala, FL. Vinyl and aluminum fences. Marion County permits handled. $0 down financing. Same-day estimates. Call (863) 377-0928.',
    heroTitle: 'Fence Installation in <span class="text-primary">Ocala, FL</span>',
    heroSubtitle: 'Marion County\'s family-owned fence team. Vinyl and aluminum fences installed in less than 7 days. $0 down financing.',
    ...
    intro: {
      ...
      paragraphs: [
        'Ocala backs up to wild Florida. Bears, coyotes, gators — they don\'t stop at property lines. We build fences that do. Whether you\'re in Marion Oaks, Heath Brook, On Top of the World, or any other Ocala neighborhood, we install premium vinyl and aluminum fences that pass inspection and outlast Florida weather.',
    ...
    whyLocal: [
      { title: 'Bear & Wildlife Protection', body: 'Ocala is in black bear territory. Our 6ft vinyl privacy panels keep bears, coyotes, and gators out of your yard.' },
    ...
    faqs: [
      ...
      { q: 'What about black bears? Will a fence keep them out?', a: 'Yes. Our 6ft <strong>vinyl privacy</strong> panels are solid and tall enough to keep bears out. We\'ve installed dozens of bear-proof fences in Ocala neighborhoods near wooded areas.' },
  ...
  'belleview-fl': {
    ...
    metaDescription: 'Fence installation in Belleview, FL (34420). Vinyl and aluminum fences. $0 down financing. Less than 7 days install. Call (863) 377-0928.',
    ...
    faqs: [
      ...
      { q: 'What\'s the cheapest fence option in Belleview?', a: '<strong>Vinyl picket fence</strong> typically starts around $4,000 for a small front yard. Vinyl privacy starts higher but include lifetime warranty.' },
    ],
  },
  'summerfield-fl': {
  ...
  'silver-springs-fl': {
    ...
    metaDescription: 'Fence installation in Silver Springs, FL (34488). East Marion County. Vinyl and aluminum fences. $0 down financing. Call (863) 377-0928.',
  ...
  'dunnellon-fl': {
    ...
    intro: {
      ...
      paragraphs: [
        'Dunnellon is one of Florida\'s most beautiful corners — Rainbow River, crystal springs, mature oaks. We install fences that match the natural beauty: clean vinyl and sleek black aluminum.',
  ...
  'marion-county-fl': {
    ...
    heroSubtitle: 'Family-owned fence installation across every city in Marion County. Vinyl and aluminum fences. $0 down financing.',
    ...
    faqs: [
      ...
      { q: 'Do you install bear-proof fences in Marion County?', a: 'Yes. Our 6ft <strong>vinyl privacy</strong> panels are solid enough to keep bears out. Especially recommended near the Ocala National Forest border.' },
    ],
  },
};
