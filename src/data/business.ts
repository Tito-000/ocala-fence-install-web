  ...
  services: [
    {
      ...
      tagline: 'Most requested · Premium look + 20-year lifespan',
      image: '/images/services/durafence.webp',
      image2: '/images/services/durafence-intro.webp',
      priceRange: { min: 3300, max: 13000 },
    ...
    },
    {
      ...
      tagline: 'Affordable, durable, secure',
      image: '/images/services/chain-link.webp',
      image2: '/images/services/chain-link-intro.webp',
      priceRange: { min: 1500, max: 5000 },
      pricePerFoot: { min: 8, max: 18 },
      priceFromMonthly: 39,
      colors: ['Galvanized Silver', 'Black Vinyl-Coated'],
      heights: ['4ft', '5ft', '6ft'],
      gateWidths: ['3ft', '4ft', '10ft'],
      windRated: '130 MPH',
    ...
    },
    {
      ...
      name: 'Wood Fence',
      shortName: 'Wood',
      tagline: 'Classic privacy with natural warmth',
      image: '/images/services/wood-fence.webp',
      image2: '/images/services/wood-fence-intro.webp',
      priceRange: { min: 3000, max: 8000 },
      pricePerFoot: { min: 20, max: 35 },
      priceFromMonthly: 59,
      colors: ['Natural Pine', 'Cedar Stained', 'Pre-Stained Brown'],
      heights: ['6ft'],
      gateWidths: ['3ft', '4ft', '5ft'],
      windRated: '110 MPH',
